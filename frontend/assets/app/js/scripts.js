...
var Bunyad_Theme = (function ($) {
    ...
    var self = {
        ...
        init_responsive_nav: function () {
            ...
            if (globalVars.min) {
                $('.top-bar .mobile-nav, .main-head .mobile-nav').magnificPopup({
                    items: {
                        src: '#search-modal-wrap-menu',
                        type: 'inline'
                    },
                    callbacks: {
                        open: function () {
                            $('.header--fixed').css('margin-right', $('html').css('margin-right'));
                        },
                        close: function () {
                            $('.header--fixed').css('margin-right', 0);
                        }
                        // e.t.c.
                    },
                    removalDelay: 400,
        ...
        sticky_bar: function () {
            ...
            var init = function () {
                ...
                // Compact has a sticky topbar configured below
                    ...
                    nav_top = head.offset().top + head.height() - 10;
                    hide_at = nav_top;
        ...
        lightbox: function () {
            ...
            if (!$.fn.magnificPopup || !$('body').hasClass('has-lb')) {
                return;
            }
...
var Bunyad_Share_Float = (function ($) {
    ...
    return {
        ...
        sticky: function () {
            ...
            add += Bunyad_Theme.has_sticky_nav ? 60 : 60;
            var width = $(window).width();

            $('.post-share-float').each(function () {

                var post_foot = $('.the-post-foot').outerHeight(true) + 50;
                $(this).css('height', $('.the-post .post-content').height() + (width > 1500 ? 0 : 0) + 'px');
