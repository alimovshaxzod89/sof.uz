    ...
    <div class="popup__container" style="max-width: 450px;">
        <div class="popup__content">
            <div class="popup__header">
                ...
                <a href="javascript:void(0)" class="popup-close-btn"><i class="ui-cancel"></i></a>
            </div>
            <div class="popup__body">
                ...
                <?= $form->field($model, 'message', [
                    'template' => "{label}{input}",
                    'options'  => ['class' => 'form-row'],
                ])->textarea(['rows' => 4, 'autofocus' => false, 'required' => true, 'placeholder' => __('Xabar matni')])->label(false) ?>

                <?php /*$form->field($model, 'reCaptcha')->widget(ReCaptcha::className(), [])->label(false) */?>

                <div class="hr smaller"></div>
                <p class="form-group">
                    <?= Html::submitButton(__('Yuborish'), ['class' => 'btn btn-lg btn-color btn-button btn-wide']) ?>
                </p>
                <?php ActiveForm::end(); ?>
            </div>
        </div>
