...
/**
 * Class Upload
 * @package backend\widgets\filekit\widget
 */
class Upload extends InputWidget
{
    ...
    {
        parent::init();
        $this->caption = __('Add comment to the image');
    ...
    protected function registerMessages()
    {
        if (!array_key_exists($this->messagesCategory, Yii::$app->i18n->translations)) {
            Yii::$app->i18n->translations[$this->messagesCategory] = [
                ...
                'basePath'       => __DIR__ . '/src/widget/messages',
                'fileMap'        => [
    ...
    public function registerClientScript()
    {
        ...
        $this->getView()->registerJs("jQuery('#{$this->getId()}').yiiUpload({$options});");
    }
}
